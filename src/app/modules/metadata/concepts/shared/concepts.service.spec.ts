...
describe('ConceptsService delete', () => {
    let service: ConceptsService;
    let httpMock: HttpTestingController;
    const id = 'urn:infai:ses:concept:co1';
    const deleteUrl = environment.deviceRepoUrl + '/concepts/' + id;
    ...
    it('should report a delete answered with an empty 200 as success', (done) => {
        service.deleteConcept(id).subscribe(resp => {
