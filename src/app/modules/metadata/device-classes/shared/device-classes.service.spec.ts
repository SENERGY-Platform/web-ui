...
import { DeviceClassesService } from './device-classes.service';
...
describe('DeviceClassesService delete', () => {
    let service: DeviceClassesService;
    let httpMock: HttpTestingController;
    const id = 'urn:infai:ses:device-class:c1';
    const deleteUrl = environment.deviceRepoUrl + '/device-classes/' + id;
    ...
    beforeEach(() => {
        ...
        service = TestBed.inject(DeviceClassesService);
    ...
    it('should report a delete answered with an empty 200 as success', (done) => {
        service.deleteDeviceClasses(id).subscribe(resp => {
