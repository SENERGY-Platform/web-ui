...
describe('AspectsService delete', () => {
    let service: AspectsService;
    let httpMock: HttpTestingController;
    const id = 'urn:infai:ses:aspect:a1';
    const deleteUrl = environment.deviceRepoUrl + '/aspects/' + id;
    ...
    it('should report a delete answered with an empty 200 as success', (done) => {
        service.deleteAspects(id).subscribe(resp => {
