...
describe('LocationsService delete', () => {
    let service: LocationsService;
    let httpMock: HttpTestingController;
    const id = 'urn:infai:ses:location:l1';
    const deleteUrl = environment.deviceRepoUrl + '/locations/' + encodeURIComponent(id);
    ...
    it('should report a delete answered with an empty 200 as success', (done) => {
        service.deleteLocation(id).subscribe(resp => {
