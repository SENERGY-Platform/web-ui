...
describe('DataTableEditDialogComponent', () => {
    ...
    beforeEach(waitForAsync(() => {
        ...
        matDialogRefSpy
            = createSpyFromClass<MatDialogRef<DataTableEditDialogComponent>>(MatDialogRef);
        dashboardServiceSpy = createSpyFromClass<DashboardService>(DashboardService);
        dataTableHelperServiceSpy
            = createSpyFromClass<DataTableHelperService>(DataTableHelperService);
        processSchedulerServiceSpy
            = createSpyFromClass<ProcessSchedulerService>(ProcessSchedulerService);
        ...
        dataTableHelperServiceSpy.preloadPipelines.and.returnValue(of([{
            id: 'pipelineId',
        ...
        dataTableHelperServiceSpy.preloadOperator.and.returnValue(of({
            name: 'opName',
            outputs: [{name: 'opValueName', type: 'string'}]
        }));
        dataTableHelperServiceSpy.preloadAllOperators.and.returnValue(of([{
            name: 'opName',
            outputs: [{name: 'opValueName', type: 'string'}]
        }]));
        ...
        TestBed.configureTestingModule({
            imports: [CoreModule, RouterTestingModule, HttpClientTestingModule, MatSnackBarModule, MatDialogModule,
                MatIconModule, MatExpansionModule, MatInputModule, ReactiveFormsModule, WidgetModule],
            declarations: [
    ...
    it('should fill device data, create deployment, create schedule, create export', waitForAsync(() => {
        const fixture = TestBed.createComponent(DataTableEditDialogComponent);
        component = fixture.componentInstance;
        fixture.detectChanges();
        ...
        expect(dashboardServiceSpy.updateWidget.calls.mostRecent().args).toEqual(['dashboardId-1',
            {
                name: 'test',
                properties: {
                    dataTable: {
    ...
    it('should enable warnings for int types', waitForAsync(() => {
        dataTableHelperServiceSpy.getServiceValues.and.returnValue([{
            Name: 'Time',
            Path: 'struct.Time',
    ...
    it('should not always create deployments and schedules', waitForAsync(() => {
    ...
    it('should not always create exports', waitForAsync(() => {
    ...
    it('should copy, move and delete elements', waitForAsync(() => {
        const fixture = TestBed.createComponent(DataTableEditDialogComponent);
        component = fixture.componentInstance;
        fixture.detectChanges();
    ...
    it('should fill pipeline data and create export', waitForAsync(() => {
        const fixture = TestBed.createComponent(DataTableEditDialogComponent);
        component = fixture.componentInstance;
        fixture.detectChanges();
